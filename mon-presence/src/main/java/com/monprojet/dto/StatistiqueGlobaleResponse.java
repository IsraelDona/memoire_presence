...
public class StatistiqueGlobaleResponse {
    ...
    private long nombreChefsService;
    ...
    public long getNombreChefsService() {
        return nombreChefsService;
    }

    public void setNombreChefsService(long nombreChefsService) {
        this.nombreChefsService = nombreChefsService;
    }
