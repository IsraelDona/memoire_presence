...
public class PresenceService {
    ...
    public boolean verifierVisage(com.monprojet.dto.FaceRegistrationRequest request) {
        ...
        /*
         * Comparaison faciale via l'API externe Face++ (Megvii).
         * La photo de référence (enregistrée à l'inscription) et la photo
         * capturée au moment du pointage sont envoyées à l'API Face++.
         * L'API retourne un score de similarité (0-100).
         * Si le score est >= 75, le visage est reconnu et le pointage autorisé.
         * Sinon, le pointage est refusé.
         */
