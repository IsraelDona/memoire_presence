...
public class JustificatifService {
    ...
    public String envoyerJustificatif(
        ...
        justificatif.setType(
                request.getType());

        justificatif.setDescription(
                request.getDescription());

        justificatif.setDateDebut(
                request.getDateDebut());

        justificatif.setDateFin(
                request.getDateFin());
        ...
        notificationService.creerNotification(
                utilisateur,
                "Justificatif envoyé",
                "Votre demande a été transmise au chef de service pour validation."
        );
    ...
    public String supprimer(Long id) {
        ...
        Justificatif justificatif =
                justificatifRepository
                        .findByIdWithUtilisateur(id)
                        .orElse(null);

        if (justificatif == null) {
            return "Justificatif introuvable";
        }
        ...
        if (utilisateur == null ||
            justificatif.getUtilisateur() == null ||
            !justificatif.getUtilisateur()
                    .getId()
                    .equals(utilisateur.getId())) {

            return "Erreur de permission: Vous ne pouvez supprimer que vos propres justificatifs";
        }
        ...
        notificationService.creerNotification(
                ...
                "Votre justificatif a été supprimé."
        );

        return "Justificatif supprimé";
    }
}