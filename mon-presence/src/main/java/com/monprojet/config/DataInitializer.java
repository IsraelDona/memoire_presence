...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(
            ...
            LieuBeninRepository lieuBeninRepository) {
    ...
    public void run(String... args) throws Exception {
     ...
     // ====================================
     // CREATION ROLE DIRECTEUR
     // ====================================

     if (roleRepository
             .findByNomRole(RoleName.DIRECTEUR)
             .isEmpty()) {

         Role directeurRole = new Role();
         directeurRole.setNomRole(RoleName.DIRECTEUR);
     ...
     // ====================================
     // CREATION DIRECTEUR PRINCIPAL
     // ====================================

     if (utilisateurRepository
             .findByEmail("directeur@dgb.com")
             .isEmpty()) {
         ...
         directeur.setPrenom("GENERAL");
         directeur.setEmail("directeur@dgb.com");
         directeur.setMotDePasse(
        ...
        // ====================================
        // AJOUT DU MINISTERE COMME LIEU PAR DEFAUT
        // ====================================

        if (lieuBeninRepository.findByNomIgnoreCase("Ministère de l'Économie et des Finances").isEmpty()) {

            LieuBenin ministere = new LieuBenin();
            ministere.setNom("Ministère de l'Économie et des Finances");
            ministere.setType("Ministère");
            ministere.setDepartement("Littoral");
            ministere.setCommune("Cotonou");
            ministere.setLatitude(6.3703);
            ministere.setLongitude(2.3912);

            lieuBeninRepository.save(ministere);

            System.out.println("MINISTERE AJOUTE AUX LIEUX PAR DEFAUT");
        }
    }
}