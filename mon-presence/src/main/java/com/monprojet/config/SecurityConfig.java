    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/admin/statistiques-globales")
                    .hasAnyAuthority("ADMINISTRATEUR", "DIRECTEUR")
                    .requestMatchers(HttpMethod.GET, "/api/admin/rapports-pdf", "/api/admin/rapports-pdf/telecharger/**")
                    .hasAnyAuthority("ADMINISTRATEUR", "DIRECTEUR")
                    .requestMatchers(HttpMethod.GET, "/api/notes/admin/classement-chefs", "/api/notes/admin/classement-agents")
                    .hasAnyAuthority("ADMINISTRATEUR", "DIRECTEUR")
                    .requestMatchers(HttpMethod.POST, "/api/notes/admin/noter/**")
                    .hasAnyAuthority("ADMINISTRATEUR", "DIRECTEUR")
