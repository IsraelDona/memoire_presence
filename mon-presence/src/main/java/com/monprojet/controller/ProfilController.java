...
public class ProfilController {
    ...
    /*
     * GET /api/profil/chef-service
     * Récupérer le chef de service de son propre service
     */
    @GetMapping("/chef-service")
    public ResponseEntity<Utilisateur> getMonChefService() {
        return ResponseEntity.ok(
                profilService.getMonChefService());
    }
