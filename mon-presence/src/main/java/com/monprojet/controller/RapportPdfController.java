...
public class RapportPdfController {
    ...
    private final com.monprojet.service.AdminService adminService;
    ...
    public RapportPdfController(
            ...
            com.monprojet.service.AdminService adminService) {
    ...
    public ResponseEntity<InputStreamResource> genererPdf(
        ...
        ByteArrayInputStream pdf = pdfService.genererRapportPdf(
                stats, generateurNom, adminService.getTousLesAgents());
        ...
        journalService.ajouter(generateurNom,"Génération du rapport PDF : " + nomFichier,"Rapport","Succès");
